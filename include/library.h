...
extern "C" {
    ...
    CSDL_EXPORT void set_event_callback(lt::session* session, cs_alert_callback callback);
    ...
    CSDL_EXPORT void set_file_dl_priority(lt::torrent_handle* torrent, lt::file_index_t file_index, const uint8_t priority);
